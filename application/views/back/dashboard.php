...
<head>
    ...
    <!-- Ionicons -->
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/back/https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">
    ...
    <!-- JQVMap -->
    <link rel="stylesheet" href="vplugins/jqvmap/jqvmap.min.css">
    <!-- Theme style -->
